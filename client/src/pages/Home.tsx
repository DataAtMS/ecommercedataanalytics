...
export default function Home() {
  ...
  useEffect(() => {
    document.title = 'Ecommerce Data Analytics: Data-backed guides on how to read ecommerce data';
    ...
    const desc = 'Your website is your biggest money-maker, but it\'s important to understand all metrics for your Ecommerce business. This website teaches you how to grow your business by understanding your key metrics. ';
    const ogImg = '';

    setMeta('meta[name="description"]', 'description', desc, 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Ecommerce Data Analytics: Data-backed guides on how to read ecommerce data', 'property');
    setMeta('meta[property="og:description"]', 'og:description', desc, 'property');
    setMeta('meta[property="og:image"]', 'og:image', ogImg, 'property');
    setMeta('meta[property="og:url"]', 'og:url', 'https://ecommercedataanalytics.com/', 'property');
    setMeta('meta[property="og:type"]', 'og:type', 'website', 'property');
    setMeta('meta[property="og:site_name"]', 'og:site_name', 'Ecommerce Data Analytics', 'property');
    setMeta('meta[name="twitter:card"]', 'twitter:card', 'summary_large_image', 'name');
    setMeta('meta[name="twitter:title"]', 'twitter:title', 'Ecommerce Data Analytics: Data-backed guides on how to read ecommerce data', 'name');
    ...
    setMeta('meta[name="twitter:site"]', 'twitter:site', '@dylanander', 'name');

    const canonical = document.querySelector('link[rel="canonical"]') as HTMLLinkElement | null;
    if (canonical) {
      canonical.setAttribute('href', 'https://ecommercedataanalytics.com/');
    }
    ...
    if (!existingScript) {
      ...
      script.textContent = JSON.stringify({
        ...
        "@type": "WebSite",
        "name": 'Ecommerce Data Analytics',
        "url": 'https://ecommercedataanalytics.com',
        "description": desc,
      });
  ...
  const COLOR = {
    ...
    accent: "#943eda",
    btnText: "#f0f0f0",  // WCAG-computed: dark on light accents, light on dark
    link: "#7236a3",
    bg: "#0a0a0a",
    bgCard: "#0d0d0d",
    border: "#1e1e1e",
    ...
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body, overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      >
        ...
        >
          ...
          >
            Ecommerce Data Analytics:<br />
            <span style={{ color: COLOR.accent }}>Data-backed guides on how to read ecommerce data</span>
          </h1>
          ...
          >
            Your website is your biggest money-maker, but it\'s important to understand all metrics for your Ecommerce business. This website teaches you how to grow your business by understanding your key metrics. {" "}
            <a
              href="https://dylanander.com"
              target="_blank"
            ...
            Dylan Ander is a world-class ecommerce expert, founder of splittesting.com, heatmap.com, and author of Billion Dollar Websites
          </p>
      ...
      >
        ...
        <div style={{ fontFamily: "Georgia, serif", fontSize: "14px", lineHeight: 1.8, color: COLOR.secondary }}>
          <p style={{ marginBottom: "1rem" }}>
            Ecommerce Data Analytics is a resource for operators and specialists who want to understand
      ...
      >
        ...
        <div style={{ borderTop: `1px solid ${COLOR.border}`, paddingTop: "20px", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "8px" }}>
          <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "10px", color: COLOR.faint }}>
            © {new Date().getFullYear()} ECOMMERCEDATAANALYTICS.COM
          </p>
          <p style={{ fontFamily: "'Space Mono', monospace", fontSize: "10px", color: COLOR.faint }}>
