...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "web-analytics": { metaTitle: 'Web analytics | Ecommerce Data Analytics', metaDescription: 'Browse 6 articles about web analytics on Ecommerce Data Analytics.', h1: 'Web analytics', intro: 'Browse 6 articles about web analytics on Ecommerce Data Analytics.' },
  "email-marketing-data": { metaTitle: 'email marketing data | Ecommerce Data Analytics', metaDescription: 'Browse 6 articles about email marketing data on Ecommerce Data Analytics.', h1: 'email marketing data', intro: 'Browse 6 articles about email marketing data on Ecommerce Data Analytics.' },
  "advertising-data": { metaTitle: 'advertising data | Ecommerce Data Analytics', metaDescription: 'Browse 6 articles about advertising data on Ecommerce Data Analytics.', h1: 'advertising data', intro: 'Browse 6 articles about advertising data on Ecommerce Data Analytics.' },
  "sms-data": { metaTitle: 'sms data | Ecommerce Data Analytics', metaDescription: 'Browse 6 articles about sms data on Ecommerce Data Analytics.', h1: 'sms data', intro: 'Browse 6 articles about sms data on Ecommerce Data Analytics.' },
  "unit-economics": { metaTitle: 'unit economics | Ecommerce Data Analytics', metaDescription: 'Browse 6 articles about unit economics on Ecommerce Data Analytics.', h1: 'unit economics', intro: 'Browse 6 articles about unit economics on Ecommerce Data Analytics.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://ecommercedataanalytics.com/' + slug;
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://ecommercedataanalytics.com' },
