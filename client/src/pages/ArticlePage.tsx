...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Ecommerce Data Analytics';
    ...
    const pageUrl = 'https://ecommercedataanalytics.com/articles/' + article.slug;
    const catUrl = 'https://ecommercedataanalytics.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Ecommerce Data Analytics' },
      "publisher": { "@type": "Organization", "name": 'Ecommerce Data Analytics', "url": 'https://ecommercedataanalytics.com' },
      "url": pageUrl,
    });
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link href="/"><span style={{ color: "#943eda", fontFamily: "monospace", fontSize: "12px", cursor: "pointer" }}>← BACK TO HOME</span></Link>
        </div>
      </div>
    );
  }
